...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $role = 'pengunjung'; // Level default sebagai 'pengunjung'
    ...
    if (mysqli_num_rows($result_email) > 0) {
        echo "<script>
                ...
                window.location.assign('../login/index.php?pesan=email_terdaftar');
              </script>";
    } else {
        ...
        if (mysqli_num_rows($result_username) > 0) {
            echo "<script>
                    ...
                    window.location.assign('../login/index.php?pesan=username_terdaftar');
                  </script>";
        } else {
            ...
            if (mysqli_query($config, $sql)) {
                ...
                echo "<script>
                        ...
                        window.location.assign('../login/index.php?pesan=gagal');
                      </script>";
            }
        }
    }
